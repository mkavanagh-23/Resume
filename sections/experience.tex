...
{Oct. 2017 - Present\duration{8 years}} % Date(s)
{
\begin{cvitems}
...
\item {Assist with management of traffic operations for the afternoon drive}
    \begin{cvitemsnested}
    \item {Help with creating and managing a monthly schedule for two primary shifts}
    \item {Monitor on-air broadcasts for all team members, addressing any broadcast issues as they occur}
    \item {Serve as primary point of contact with, and assist remote IT with tech issues for both in-office and at-home employees}
