...
\begin{tabular*}{\leftcolumnwidth - \sidemargin}{cR{\leftcolumnwidth - \sidemargin + \iconswidth}@{}}
    \hobbyiconstyle{\caddressicon} & \hobbiesstyle{\caddress} \\
    \hobbyiconstyle{\cmobileicon} & \hobbiesstyle{\cmobile} \\
    \hobbyiconstyle{\cemailicon} & \hobbiesstyle{\cemail} \\
    \hobbyiconstyle{\chomepageicon} & \hobbiesstyle{\chomepage} \\
    \hobbyiconstyle{\clinkedinicon} & \hobbiesstyle{\clinkedinuser} \\
    \hobbyiconstyle{\cgiticon} & \hobbiesstyle{\cgituser} \\
\end{tabular*}
